...
const BOX_PADDING_Y = 150
const BOX_WIDTH = WIDTH - BOX_PADDING_X * 2
const BOX_HEIGHT = HEIGHT - TITLE_HEIGHT - BOX_PADDING_Y * 2
const GRAPH_TITLE_WIDTH = 200
const BOX_START_POSITION_X = BOX_PADDING_X
const BOX_START_POSITION_Y = TITLE_HEIGHT + BOX_PADDING_Y
...
const Title = () => {
  ...
  ctx.fillText("西暦・元号・天皇・時代対応グラフ", WIDTH/2, TITLE_HEIGHT/2 + TITLE_FONT_SIZE/2 + BOX_PADDING_Y/2);
}
